function lc_roi_segmentation_v1(varargin)
% LC_ROI_SEGMENTATION_V1
...
% EXAMPLE 2 :
% lc_roi_segmentation_v1('-dd', 'D:\workstation_b\ZhangYue_Guangdongshengzhongyiyuan\signals',...
...
% EXAMPLE 1:
% lc_roi_segmentation_v1('-dd', 'D:\FunImgARWSFC',...
%                     '-rs', 'D:\roi_3_3_3.nii',...
%                     '-ns', 2,... 
%                     '-mf', 'D:\sorted_brainnetome_atalas_3mm.nii',...
%                     '-od', 'D:\Results');

help lc_roi_segmentation_v1
fprintf('-----------------------------------------------------------\n');
